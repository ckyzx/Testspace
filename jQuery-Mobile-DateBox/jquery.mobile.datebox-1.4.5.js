...
jQuery.extend(jQuery.mobile.datebox.prototype.options.lang, { "zh-CN": {
    "setDateButtonLabel": "璁剧疆鏃ユ湡",
    "setTimeButtonLabel": "璁剧疆鏃堕棿",
    "setDurationButtonLabel": "璁剧疆鎸佺画鏃堕棿",
    "calTodayButtonLabel": "閫夋嫨浠婂ぉ鏃ユ湡",
    "titleDateDialogLabel": "閫夋嫨鏃ユ湡",
    "titleTimeDialogLabel": "閫夋嫨鏃堕棿",
    "daysOfWeek": [
        "鏄熸湡鏃�",
        "鏄熸湡涓€",
        "鏄熸湡浜�",
    ...
    "timeOutput": "%l:%M %p",
    "durationFormat": "%Dd %DA, %Dl:%DM:%DS",
    "calDateListLabel": "鍏朵粬鏃ユ湡",
    "calHeaderFormat": "%B %Y",
    "calTomorrowButtonLabel": "璺宠浆鍒版槑澶�"
}});
jQuery.extend(jQuery.mobile.datebox.prototype.options, {
    useLang: "zh-CN"
});